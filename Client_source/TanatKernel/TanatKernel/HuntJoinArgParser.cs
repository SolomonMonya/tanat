...
{
	internal class HuntJoinArgParser : CtrlPacketArgParser<HuntJoinArg>
	{
		protected override void ParseArg(CtrlPacket _packet, ref HuntJoinArg _arg)
		{
			...
			_arg.mFighter = new Fighter();
			_arg.mFighter.mId = SafeGet(_packet, "user_id", 0);
			_arg.mFighter.mNick = SafeGet(_packet, "nick", "");
			_arg.mFighter.mTag = SafeGet(_packet, "tag", "");
			_arg.mFighter.mTeam = 1;
