...
namespace UnityEngine
{
	internal sealed class GUIClip
	{
		...
		{
			Clip_Rect(ref absoluteRect);
			return absoluteRect;
		}

		private static Rect Clip_Rect(ref Rect absoluteRect)
		{
			return INTERNAL_CALL_Clip_Rect(ref absoluteRect);
		}

		[MethodImpl(MethodImplOptions.InternalCall)]
		[WrapperlessIcall]
		private static extern Rect INTERNAL_CALL_Clip_Rect(ref Rect absoluteRect);
