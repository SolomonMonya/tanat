...
namespace UnityEngine
{
	public sealed class Mesh : Object
	{
		...
		public void Clear()
		{
			INTERNAL_CALL_Clear(this);
		}

		[MethodImpl(MethodImplOptions.InternalCall)]
		[WrapperlessIcall]
		private static extern void INTERNAL_CALL_Clear(Mesh self);
		...
		{
			INTERNAL_CALL_Optimize(this);
		}

		[MethodImpl(MethodImplOptions.InternalCall)]
		[WrapperlessIcall]
		private static extern void INTERNAL_CALL_Optimize(Mesh self);
